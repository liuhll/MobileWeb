...
namespace Jueci.MobileWeb.Web
{
    public class SwaggerConfig
    {
                ...
                .EnableSwagger(c =>
                    {
                        ...
                        //
                        c.SingleApiVersion("v1", "Jueci.MobileWeb.Web");
                        ...
                        c.IncludeXmlComments(GetApiXmlCommentsPath());
                        c.IncludeXmlComments(GetModelsXmlCommentsPath());
        ...
        private static string GetModelsXmlCommentsPath()
        {
#if DEBUG
            var path = Directory.GetParent(System.AppDomain.CurrentDomain.BaseDirectory).Parent;
