    ...
    public static class BrowerChecker
    {
        ...
        public static bool IsMoblie(HttpRequestBase request)
        {
            ...
            if (userAgent != null)
            {
                ...
                if (_mobileCheck.IsMatch(userAgent) || _mobileVersionCheck.IsMatch(userAgent.Substring(0, 4)))
                    return true;
            }
        ...
        public static bool IsIphone(HttpRequestBase request)
        {
        ...
        public static bool IsWeChatBrower(HttpRequestBase request)
        {
            var userAgent = HttpContext.Current.Request.UserAgent.ToLower();
